...
//            viewModel.insertOfficialCourse(course)
            ...
            val userRecords = listOf(
                UserRecord("UR101", "AD101", true, "2024-05-10","1233"),
                UserRecord("UR102", "AD102", false, "2024-05-11","123"),
                UserRecord("UR103", "AD103", true, "2024-05-12","1234"),
                UserRecord("UR104", "AD104", false, "2024-05-13","12341")
            )

            userRecords.forEach { record ->
                viewModel.insertUserRecord(record)
            }
        }
    }
}
...
//
//            val userRecords = listOf(
//                UserRecord("UR101", "AD101", true, "2024-05-10"),
//                UserRecord("UR102", "AD102", false, "2024-05-11"),
//                UserRecord("UR103", "AD103", true, "2024-05-12"),
//                UserRecord("UR104", "AD104", false, "2024-05-13")
//            )
//
//            userRecords.forEach { record ->
//                viewModel.insertUserRecord(record)
