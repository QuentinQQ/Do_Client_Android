    ...
    private fun populateInitialData() {
        lifecycleScope.launch {
            ...
            val userRecords = listOf(
                UserRecord("UR101", "user111", false,"2024-05-10","FM101", "Flat Bench Press", 3, 1,30.00,15),
                UserRecord("UR102", "user111", false, "2024-05-10","FM102", "Incline Bench Press", 3, 1,30.00,15),
                UserRecord("UR103", "user111", true, "2024-05-10","FM103", "Decline Bench Press", 3, 1,30.00,15),
                UserRecord("UR104", "user111", true, "2024-05-10","FM205", "Back Extension", 3, 1,30.00,15),
            )
